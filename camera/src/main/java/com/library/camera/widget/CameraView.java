package com.library.camera.widget;
...
import com.library.camera.R;
import com.library.camera.listener.CaptureListener;
...
import com.library.camera.listener.TypeListener;
import com.library.camera.state.CameraMachine;
import com.library.camera.util.FileUtil;
import com.library.camera.util.LogUtil;
import com.library.camera.util.ScreenUtil;

import java.io.IOException;

public class CameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder.Callback, com.library.camera.view.CameraView {
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.CameraView_iconSrc, R.drawable.ic_camera_switch);
    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void recordShort(final long time) {
                ...
                mFlashLamp.setVisibility(INVISIBLE);/*mFlashLamp.setVisibility(VISIBLE);//隐藏功能*/
