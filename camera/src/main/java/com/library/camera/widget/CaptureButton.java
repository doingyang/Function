...
import com.library.camera.util.CheckPermission;
import com.library.camera.util.LogUtil;

import static com.library.camera.widget.CameraView.BUTTON_STATE_BOTH;
import static com.library.camera.widget.CameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.library.camera.widget.CameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFF2481FC;            //进度条颜色
    ...
    private void updateProgress(long millisUntilFinished) {
        ...
        // +1f 解决进度条绘制不全问题
        progress = 361f - millisUntilFinished / (float) duration * 360f;
        invalidate();
    }
