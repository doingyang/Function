...
import com.library.camera.listener.ReturnListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    public CaptureLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        layout_height = button_size + (button_size / 5) * 2 + 150;
...
//                resetCaptureLayout();
        ...
        // 返回按钮（默认向下箭头的返回按钮）
        btn_return = new ReturnButton(getContext(), (int) (button_size / 3.5f));
        ...
        txt_tip.setText(R.string.tip_photo_video);
